...
<body>
        ...
        <div id="chatWindow" class="hidden slide-up bg-white rounded-2xl shadow-2xl overflow-hidden mb-4 flex flex-col">
            ...
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-4 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="font-bold text-lg">UnitelBot Policy</h3>
            ...
            <div class="flex-shrink-0 p-4 bg-white border-t border-gray-200">
                ...
                <div class="flex flex-wrap gap-2 mt-3">
                    <button class="quick-action px-3 py-1.5 bg-gray-100 text-gray-700 rounded-full text-xs hover:bg-gray-200 transition-all duration-200 transform hover:scale-105" data-thread="chinhSach">
    ...
    <script>
        const languages = {
            vi: {
                welcome: "📄 Chào bạn! Đây là kênh hỗ trợ về chính sách dịch vụ. Bạn cần hỏi gì ạ?",
                placeholder: "Nhập tin nhắn của bạn...",
            ...
            en: {
                welcome: "📄 Hello! This is the service policy support channel. What do you need help with?",
            ...
            lo: {
                welcome: "📄 ສະບາຍດີ! ນີ້ແມ່ນຊ່ອງທາງສະໜັບສະໜູນກ່ຽວກັບນະໂຍບາຍການບໍລິການ. ເຈົ້າຕ້ອງການຄວາມຊ່ວຍເຫຼືອຫຍັງ?",
                placeholder: "ພິມຂໍ້ຄວາມ ...",
                online: "ພ້ອມຊ່ວຍເຫຼືອ",
                copy: "ຄັດລອກຂໍ້ຄວາມ",
                copied: "ຄັດລອກແລ້ວ!",
                disclaimer: "ຂໍ້ມູນນີ້ແມ່ນສຳລັບການອ້າງອີງເທົ່ານັ້ນ, ສະໜອງໂດຍ AI Agent.",
                policy: "ນະໂຍບາຍການບໍລິການ",
                register: "ລົງທະບຽນ",
        ...
        class ChatWidget {
            constructor() {
                ...
                this.activeThread = 'chinhSach'; // Default thread
            ...
            updateUILanguage() {
                ...
                $('.quick-action[data-thread="chinhSach"]').html(`
                    <i class="fas fa-phone mr-1"></i>
                    ${this.getText('policy')}
                `);
            }
            ...
            init() {
                ...
                this.switchThread('chinhSach'); // Render default thread
            }
            ...
            sendMessage() {
                ...
                // Disable suggestions ngay khi user gửi tin nhắn
            ...
            addBotMessage(message) {
                        ...
                        <div class="flex items-start space-x-3 slide-up mt-2">
                            ...
                            <div class="flex flex-wrap gap-2 max-w-[300px]">
                                ${suggestions.map((suggestion, index) => `
                                    <button class="suggestion-btn px-3 py-2 bg-orange-50 text-orange-700 rounded-lg text-sm hover:bg-orange-100 transition-all duration-200 border border-orange-200 text-left" onclick="selectSuggestion('${suggestion.replace(/'/g, '\\\'').replace(/"/g, '&quot;')}')">
                                        ${suggestion}
                                    </button>
                                `).join('')}
                            </div>
                ...
                if (hasLink) {
                    const label = this.getText('register');
                    const buttonHtml = `
                        <div class="flex items-start space-x-3 slide-up">
                            <div class="w-8 h-8"></div>
                            <div>
            ...
            simulateBotResponse(userMessage) {
                const url = 'https://408b-14-231-188-210.ngrok-free.app/webhook/policies'; // Chỉ dùng policies URL
                fetch(url, {
                    method: "POST",
        ...
        function selectSuggestion(text) {
            // Kiểm tra nếu đang typing thì không cho phép
            if (!$('#typingIndicator').hasClass('hidden')) {
                return false;
            }
