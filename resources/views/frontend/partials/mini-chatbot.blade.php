<div id="chatbot-button">
    <div class="chatbot-tooltip">
        <strong>{{ trans('frontend.chatbot_name') }}</strong><br>
        {{ trans('frontend.chatbot_tooltip_content') }}
    </div>
    <img src="{{ asset('frontend/assets/chatbot-icon.svg') }}" alt="Chatbot"/>
</div>
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        #chatbot-messages {
        height: calc(85vh - 160px); /* header + input height */
    }
    }
</style>
    ...
    function sendMessage() {
        ...
        if (text) {
            ...
            if (matched) {
                ...
                const formatAnswer = matched.answer
                    .replace(/ - /g, "<br>")
                    .replace(/\n/g, "<br>")
                ...
                setTimeout(() => {
                    ...
                    appendMessage("Trợ lý ảo Unitel", formatAnswer);
                }, 2500);
                return;
            }
